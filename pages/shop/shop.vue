<template>
	<view class="u-wrap">
		<view class="u-search-box">
			<u-search placeholder="搜索商品" @change="$u.debounce(searchGoods, 500)" v-model="keyword" @custom="searchGoods"
				:clearabled="true" @clear="clearFn">
			</u-search>
		</view>
					...
					<view class="page-view">
						<view class="class-item">
							<view class="item-container">
								<view class="thumb-box u-p-40" v-for="(item) in goodsList" :key="item.id" @click="toDetial(item.id)">
									<image class=" item-menu-image" :src="item.cover_url">
									</image>
